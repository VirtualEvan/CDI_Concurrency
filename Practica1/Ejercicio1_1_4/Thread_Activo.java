...
/**
 * @brief Creación de hilos usando la clase Thread y usando los metodos activeCount y currentThread para postrar el numero de hilos y el hilo actual
 * @author Nara, Javier, Esteban
 */
public class Thread_Activo extends Thread {
    /**
...
public static void main (String[] args){
        System.out.println("Hilos activos clase Thead");
        (new Thread_Activo()).start();
    }
}
