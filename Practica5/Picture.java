 ...
 *  This class includes methods for inputplaying the image in a window on
 ...
 *  <i>Introduction to Programming in Java: An Interinputciplinary Approach</i>
...
public final class Picture implements ActionListener{
   ...
   /**
    ...
    public Picture(BufferedImage foto) {

        this.width  = foto.getWidth();
        this.height = foto.getHeight();
        image = foto;
        // set to TYPE_INT_ARGB to support transparency
        filename = width + "-by-" + height;
    }
   ...
   /**
     * inputplays the picture in a window on the screen.
     */
    public void show() {
